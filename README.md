...
![Product Gif](https://github.com/umutesen/music-listening-analysis/blob/media/material-template-demo.gif)
...
## Demo
[View Demo](http://demo.onthecode.co.uk/music-listening-analysis)

## Quick start
Start by downloading the template from one of these locations:

- [Download from Github](https://github.com/umutesen/music-listening-analysis/archive/master.zip)
...
7. Use your favourite IDE to **rebrand** the project. Just search and replace all occurances of `music-listening-analysis` with your project name.
...
<img src="https://github.com/umutesen/music-listening-analysis/blob/media/chrome.png?raw=true" width="64" height="64"><img src="https://github.com/umutesen/music-listening-analysis/blob/media/firefox.png?raw=true" width="64" height="64"><img src="https://github.com/umutesen/music-listening-analysis/blob/media/edge.png?raw=true" width="64" height="64"><img src="https://github.com/umutesen/music-listening-analysis/blob/media/safari.png?raw=true" width="64" height="64"> <img src="https://github.com/umutesen/music-listening-analysis/blob/media/opera.png?raw=true" width="64" height="64">
...
## Resources
- Demo: <http://demo.onthecode.co.uk/music-listening-analysis>
- Download Page: <https://onthecode.co.uk/product/music-listening-analysis>
- License Agreement: [License Agreement](https://github.com/umutesen/music-listening-analysis/blob/master/LICENSE)
- Support: [Ask onthecode](https://onthecode.co.uk/ask-question)
- Issues: [Github Issues](https://github.com/umutesen/music-listening-analysis/issues)
...
- Licensed under MIT [License Agreement](https://github.com/umutesen/music-listening-analysis/blob/master/LICENSE)
